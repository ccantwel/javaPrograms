    ...
    public static void main(String[] args) {
        ...
        while (done == false) {
            ...
            if (option == 1) {
                ...
                for (x = 0; x < value.length; x++) {
                    System.out.println("Value at " + x + " is " + value[x]);
                }
                //System.exit(0);
            } else if (option == 7) {
                for (x = 0; x < originalNumbers.length; x++) {
                    System.out.println("originalNumbers at " + x + " is " + originalNumbers[x]);
                }
                //System.exit(0);
            } else {
